...
not good enough detects any moving object in frame, and
background is calibrated initially which is persistant
"""
#global variables
bg = None
frames = []
...
if __name__ == "__main__":
    ...
    while(True):
        ...
        cv2.rectangle(clone, (0,0), (height, width), (0,255,0), 2)
